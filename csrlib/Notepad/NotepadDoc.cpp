...
void CNotepadDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CNotepadDoc::InitializeSearchContent()
{
...
void CNotepadDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
